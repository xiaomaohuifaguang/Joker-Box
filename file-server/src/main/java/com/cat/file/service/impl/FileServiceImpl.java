...
public class FileServiceImpl implements FileService {
    ...
    public FileInfo upload(MultipartFile uploadFile) throws IOException {
        ...
        return StringUtils.hasText(minioService.putObject(BUCKET_NAME, fileInfo.getId(), uploadFile.getInputStream(), uploadFile.getContentType())) && fileInfoMapper.insert(fileInfo) == 1
                ? fileInfo : null;
    }
