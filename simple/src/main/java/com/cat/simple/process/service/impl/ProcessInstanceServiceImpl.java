...
//                instance.setTaskForm(taskForm);
            ...
            List<NextUserTaskInfo> nextUserTaskInfosSkipGateway = flowableUtils.findNextUserTaskInfosSkipGateway(processDefinition.getProcessKey(), processDefinition.getVersion(),
